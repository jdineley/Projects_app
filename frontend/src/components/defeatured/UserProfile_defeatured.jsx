...
import PendingVacationRequests from "../PendingVacationRequests";
import ApprovedVacationRequests from "../ApprovedVacationRequests";
import RejectedVacationRequests from "../RejectedVacationRequests";
...
export default function UserProfile_defeatured({ userObj }) {
    ...
    <>
      ...
      >
        <Card className="flex-1">
          ...
          <div className="border-b border-solid border-0 border-slate-200 pointer-events-none">
